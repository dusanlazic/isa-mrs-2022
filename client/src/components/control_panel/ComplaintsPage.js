...
import RespondToComplaintModal from "../modals/complaint/RespondToComplaintModal";
      ...
      <div className="flex flex-col divide-y divide-dashed h-full border-0.5 rounded-lg gap-y-8">
        ...
        <div key={index} className="block rounded-lg">
          <div className="grid grid-cols-10 pt-3">
            ...
            <div className="block col-span-3 gap-x-2">
              ...
              text-white rounded-lg py-2.5 lg:py-2 text-sm lg:text-base w-1/3 mb-1.5 mt-3 md:mt-0"
