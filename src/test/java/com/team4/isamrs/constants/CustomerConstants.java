...
public class CustomerConstants {
    ...
    public static final String DB_COUNTRY_CODE = "RS";
    public static final String DB_CITY = "Novi Sad";
    public static final String DB_PHONE_NUMBER = "4369916287";
    public static final String DB_ADDRESS = "Kod mene kući BB";;
}
